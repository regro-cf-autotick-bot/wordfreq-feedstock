...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wordfreq-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14251&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wordfreq-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wordfreq` can be installed with:

```
conda install wordfreq
```

It is possible to list all of the versions of `wordfreq` available on your platform with:
